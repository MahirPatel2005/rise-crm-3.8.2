...
class PayU_Payment_Method_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "PayU_Payment_Method";
    ...
    function index() {
        ...
        echo $this->template->view("PayU_Payment_Method\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("payu_payment_method_item_purchase_code");
