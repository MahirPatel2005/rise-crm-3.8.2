...
class Jitsi_Integration_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'jitsi_integration_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('jitsi_integration_settings');
