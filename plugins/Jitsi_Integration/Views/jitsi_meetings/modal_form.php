<?php echo form_open(get_uri("jitsi_meetings/save"), array("id" => "meeting-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
        <div class="form-group">
            <div class="row">
                <label for="title" class=" col-md-3"><?php echo app_lang('jitsi_integration_topic'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        ...
                        "class" => "form-control",
                        "placeholder" => app_lang('jitsi_integration_topic'),
                        "autofocus" => true,
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class=" col-md-9">
                    ...
                    <!--Clients-->
                    <?php if (get_jitsi_integration_setting("client_can_access_meetings")) { ?>
                        <div class="share-with-section">
                            <div>
                                ...
                                ?>
                                <label for="share_with_all_client_contacts"><?php echo app_lang("jitsi_integration_all_client_contacts"); ?></label>
                            </div>
    ...
    $(document).ready(function () {
        $("#meeting-form").appForm({
            onSuccess: function (result) {
                $("#jitsi-meeting-table").appTable({newData: result.data, dataId: result.id});
            }
        });
