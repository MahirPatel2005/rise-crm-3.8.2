...
class Jitsi_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Jitsi_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Jitsi_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_jitsi_integration_setting("jitsi_integration_item_purchase_code");
