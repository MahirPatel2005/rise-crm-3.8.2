...
class Timecamp_Integration_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'timecamp_integration_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('timecamp_integration_settings');
