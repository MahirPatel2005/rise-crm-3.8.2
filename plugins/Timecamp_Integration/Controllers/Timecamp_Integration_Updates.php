...
class Timecamp_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->app_update_url = "https://releases.codenplug.com/";
        $this->product = "Timecamp_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Timecamp_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_timecamp_integration_setting("timecamp_integration_item_purchase_code");
