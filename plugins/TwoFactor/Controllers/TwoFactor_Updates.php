...
class TwoFactor_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("TwoFactor\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_twofactor_setting("twofactor_item_purchase_code");
