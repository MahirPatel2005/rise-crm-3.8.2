...
class Recruitment_settings_model extends \App\Models\Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'recruitment_settings';
        parent::__construct($this->table);
    }

    function get_recruitment_setting($setting_name) {
    ...
    function save_recruitment_setting($setting_name, $setting_value, $type = "app") {
        $fields = array(
            'setting_name' => $setting_name,
            'setting_value' => $setting_value
        );

        $exists = $this->get_recruitment_setting($setting_name);
        if ($exists === NULL) {
