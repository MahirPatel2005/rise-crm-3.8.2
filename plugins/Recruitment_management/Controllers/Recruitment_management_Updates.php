...
class Recruitment_management_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Recruitment_management";
    ...
    function index() {
        ...
        echo $this->template->view("Recruitment_management\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("recruitment_management_item_purchase_code");
...
/* End of file Recruitment_management_Updates.php */
/* Location: ./plugins/Recruitment_management/Controllers/Recruitment_management_Updates.php */