        ...
        <div class="card">
            ...
            <div id="app-update-container" class="card-body font-14">
                ...
                <div class="b-t pt15 mt10">
                    <?php echo anchor("poll_updates/systeminfo", "Php Info", array("class" => "btn btn-warning", "target" => "_blank")); ?>
                </div>
    ...
    $(document).ready(function () {
        var startDownload = function () {
            ...
            if ($link.length) {
                ...
                $.ajax({
                    url: "<?php echo_uri("poll_updates/download_updates/"); ?>" + "/" + version + "/" + salt,
                    dataType: "json",
        ...
        $('body').on('click', '.do-update', function () {
            ...
            $.ajax({
                url: "<?php echo_uri("poll_updates/do_update/"); ?>" + "/" + version,
                dataType: "json",
                success: function (response) {
