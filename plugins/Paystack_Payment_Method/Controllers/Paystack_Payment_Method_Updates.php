...
class Paystack_Payment_Method_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Paystack_Payment_Method";
    ...
    function index() {
        ...
        echo $this->template->view("Paystack_Payment_Method\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_setting("paystack_payment_method_item_purchase_code");
