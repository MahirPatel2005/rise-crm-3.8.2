...
class SqlScriptParser
{
    ...
    public function removeComments($sql)
    {
        ...
        while (true) {
            ...
            if (false === $quoteStart && false === $lineStart && false === $blockStart) {
                break;
            }
    ...
    private function getSemiColonPos(&$sql, $offset)
    {
        ...
        while (true) {
            ...
            $lineStart    = strpos($sql, '--', $seekPos);
            $blockStart   = strpos($sql, '/*', $seekPos);
            if (false === $semiColonPos && false === $quoteStart && false === $lineStart && false === $blockStart) {
                return false;
            }
    ...
    {
        return false !== $var1
            && ($var1 < $var2 || false === $var2)
            && ($var1 < $var3 || false === $var3)
            && ($var1 < $var4 || false === $var4);
    }
