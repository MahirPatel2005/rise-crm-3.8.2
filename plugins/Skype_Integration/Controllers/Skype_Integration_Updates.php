...
class Skype_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Skype_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Skype_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_skype_integration_setting("skype_integration_item_purchase_code");
