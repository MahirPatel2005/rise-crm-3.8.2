...
class Skype_Integration_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'skype_integration_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('skype_integration_settings');
