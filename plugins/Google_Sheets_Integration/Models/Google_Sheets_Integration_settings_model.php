...
class Google_Sheets_Integration_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'google_sheets_integration_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('google_sheets_integration_settings');
