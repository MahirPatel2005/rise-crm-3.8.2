...
class Banner_Manager_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Banner_Manager\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_banner_manager_setting("banner_manager_item_purchase_code");
