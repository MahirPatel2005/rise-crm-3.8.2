<div class="card bg-white mb15">
    <div class="card-header text-center">
        ...
        <?php } else { ?>
            <h2><?php echo app_lang('reset_session'); ?></h2>
        <?php } ?>
    </div>
    <div class="card-body p30 rounded-bottom">
        <?php echo form_open('riseguard/reset_session', array('id' => 'reset-session-form', 'class' => 'general-form', 'role' => 'form')); ?>
        ...
        <button class="w-100 btn btn-lg btn-primary" type="submit"><?php echo app_lang('reset_session'); ?></button>
