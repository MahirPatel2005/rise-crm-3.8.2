...
class AWS_S3_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "AWS_S3_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("AWS_S3_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_aws_s3_integration_setting("aws_s3_integration_item_purchase_code");
