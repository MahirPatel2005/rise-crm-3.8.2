...
namespace AWS_S3_Integration\Models;

use App\Models\Crud_model;

class AWS_S3_Integration_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'aws_s3_integration_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('aws_s3_integration_settings');
