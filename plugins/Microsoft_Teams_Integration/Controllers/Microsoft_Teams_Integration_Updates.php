...
class Microsoft_Teams_Integration_Updates extends Security_Controller {
    ...
    function __construct() {
        ...
        $this->product = "Microsoft_Teams_Integration";
    ...
    function index() {
        ...
        echo $this->template->view("Microsoft_Teams_Integration\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_microsoft_teams_integration_setting("microsoft_teams_integration_item_purchase_code");
