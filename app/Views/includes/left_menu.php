<div class="sidebar sidebar-off">
    ...
    <a class="sidebar-brand brand-logo" href="<?php echo $dashboard_link; ?>" style="display: flex; align-items: center; justify-content: center; padding: 0; height: 66px; width: 250px;"><img class="dashboard-image"
            src="<?php echo get_logo_url(); ?>"
            style="max-height: 100px; max-width: 320px; width: auto; object-fit: contain; display: block; margin: 0 auto;" /></a>
